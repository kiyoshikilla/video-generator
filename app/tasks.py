...
def process_video(self, request_data: dict):
    ...
    with tempfile.TemporaryDirectory() as temp_dir_str:
        ...
        try:
            print("Downloading assets sequentially...")
            ...
            for block_name, urls in request.video_blocks.items():
                ...
                for idx, url in enumerate(urls):
                    ...
                    success = download_video(str(url), dest)
                    if not success:
        ...
        try:
            results = create_video(
                video_blocks=local_video_blocks,
                audio_blocks=local_audio_blocks,
